...
import (
	rpc "github.com/dl-alexandre/gdrv/pkg/gen/google/rpc"
...
type ActionStatus struct {
	...
	// The status code.
	StatusCode rpc.Code `protobuf:"varint,1,opt,name=status_code,json=statusCode,proto3,enum=google.rpc.Code" json:"status_code,omitempty"`
...
func (x *ActionStatus) GetStatusCode() rpc.Code {
	if x != nil {
		return x.StatusCode
	}
	return rpc.Code(0)
...
const file_google_chat_v1_action_status_proto_rawDesc = "" +
	...
	"statusCode\x12.\n" +
	"\x13user_facing_message\x18\x02 \x01(\tR\x11userFacingMessageB\xbd\x01\n" +
	"\x12com.google.chat.v1B\x11ActionStatusProtoP\x01Z:github.com/dl-alexandre/gdrv/pkg/gen/google/chat/v1;chatv1\xa2\x02\x03GCX\xaa\x02\x0eGoogle.Chat.V1\xca\x02\x0eGoogle\\Chat\\V1\xe2\x02\x1aGoogle\\Chat\\V1\\GPBMetadata\xea\x02\x10Google::Chat::V1b\x06proto3"
