...
const file_google_chat_v1_deletion_metadata_proto_rawDesc = "" +
	"\n" +
	"&google/chat/v1/deletion_metadata.proto\x12\x0egoogle.chat.v1\"\x97\x02\n" +
	"\x10DeletionMetadata\x12R\n" +
	"\rdeletion_type\x18\x01 \x01(\x0e2-.google.chat.v1.DeletionMetadata.DeletionTypeR\fdeletionType\"\xae\x01\n" +
	"\fDeletionType\x12\x1d\n" +
	"\x19DELETION_TYPE_UNSPECIFIED\x10\x00\x12\v\n" +
	"\aCREATOR\x10\x01\x12\x0f\n" +
	"\vSPACE_OWNER\x10\x02\x12\t\n" +
...
var (
	...
	file_google_chat_v1_deletion_metadata_proto_rawDescData []byte
)
...
func file_google_chat_v1_deletion_metadata_proto_rawDescGZIP() []byte {
	file_google_chat_v1_deletion_metadata_proto_rawDescOnce.Do(func() {
		file_google_chat_v1_deletion_metadata_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_chat_v1_deletion_metadata_proto_rawDesc), len(file_google_chat_v1_deletion_metadata_proto_rawDesc)))
	})
...
func file_google_chat_v1_deletion_metadata_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_chat_v1_deletion_metadata_proto_rawDesc), len(file_google_chat_v1_deletion_metadata_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
